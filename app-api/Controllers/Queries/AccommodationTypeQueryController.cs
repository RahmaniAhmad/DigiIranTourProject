...
namespace app_api.Controllers.Queries
{
    ...
    public class AccommodationTypeQueryController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;

        public AccommodationTypeQueryController(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<IActionResult> GetAll(CancellationToken cancellationToken = default)
        {
            try
            {
                var cities = await _unitOfWork.AccommodationTypes.GetListAsync(cancellationToken);
