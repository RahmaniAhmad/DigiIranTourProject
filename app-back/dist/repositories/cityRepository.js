...
class CityRepository {
    getAll(filter, page = 1, limit = const_1.LIMIT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let dataCount = 0;
            if (filter !== undefined) {
                data = yield dbPrisma_1.default.city.findMany({
                    orderBy: { id: "asc" },
                ...
                dataCount = Math.ceil((yield dbPrisma_1.default.city.count()) / limit);
            }
            return {
                data: data,
                rowsCount: dataCount,
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield dbPrisma_1.default.city.create({
                data: data,
            });
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield dbPrisma_1.default.city.delete({
                where: { id: id },
            });
